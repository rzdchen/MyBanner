 ...
 * 数字指示器
 */
public class MyNumIndicator extends FrameLayout implements MyIndicator<FrameLayout> {
    ...
    public MyNumIndicator(Context context) {
        this(context, null);
    }

    public MyNumIndicator(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyNumIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
